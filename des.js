...
let llave = bin("133457799BBCDFF1"); // hex
let msg = bin("0123456789ABCDEF"); // hex
let enc = cifrar(msg, llave);

/*console.log(enc); // => 85E813540F0AB405
console.log(descifrar(bin(enc), llave)); // => 0123456789ABCDEF*/

// Triple DES (3DES)
// Variante 2: Dos Llaves (K1 = K3)

let llave2 = bin("0DAE3BF4ECCAD161");

let tripleEnc = cifrar(msg, llave);
tripleEnc = descifrar(bin(tripleEnc), llave2);
tripleEnc = cifrar(bin(tripleEnc), llave);
//console.log(tripleEnc); // => DDF3FFA6F0FC22DC

let tripleDec = descifrar(bin(tripleEnc), llave);
tripleDec = cifrar(bin(tripleDec), llave2);
tripleDec = descifrar(bin(tripleDec), llave);
//console.log(tripleDec); // => 0123456789ABCDEF

module.exports = {asciiToHex, hexToAscii, bin, cifrar, descifrar}